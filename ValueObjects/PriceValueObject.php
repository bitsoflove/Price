...
class PriceValueObject
{
     ...
     * @return string
     */
    public function format($currency = false, $decimals = null)
    {
     ...
     * @return string
     */
    public function formatWithCurrency($decimals = null)
    {
        return $this->format(true, $decimals);
    }
    ...
    public function toArray()
    {
        return [
            ...
            'formatted_with_currency' => $this->formatWithCurrency(),
